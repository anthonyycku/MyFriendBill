...
const Page2 = () => {
  return (
    <div className="flex flex-col space-y-4">
      <p className="font-medium text-lg">The basics</p>
      ...
      <p className="font-medium text-lg">Creating a new debt</p>
      ...
      <span className="flex flex-col lg:flex-row lg:space-x-2">
        <p className="font-medium">Amount:</p><p>Must be a number and rounds to 2 decimal places.</p>
      </span>

      <span className="flex flex-col lg:flex-row lg:space-x-2">
        <p className="font-medium">Description:</p><p>Text. Optional.</p>
      </span>

      <span className="flex flex-col lg:flex-row lg:space-x-2">
        <p className="font-medium">Due Date:</p><p>Deadline for the bill. If date isn't relevant, it can default to null if left empty or by clicking on "No Due Date" button.</p>
      </span>

      <span className="flex flex-col lg:flex-row lg:space-x-2">
        <p className="font-medium">Frequency:</p><p>Time between each recurrence. Options are: One time, weekly, bi-weekly, monthly, every 2 months, every 3 months, every 6 months, annually.</p>
      </span>

      <span className="flex flex-col lg:flex-row lg:space-x-2">
        <p className="font-medium">Notes:</p><p>Text. Optional. Not shown on table.</p>
      </span>

      <Divider/>

      <p className="font-medium text-lg">Updating an existing debt</p>
